...
class Experiment(object):
    ...
    def __init__(self, net, train_set, val_set, test_set, optimizer, stats_manager,
        ...
        # Define data loaders
        self.train_loaders = [td.DataLoader(x, batch_size=cfg.BATCH_SIZE, shuffle=cfg.SHUFFLE,
                                     drop_last=cfg.DROP_LAST, pin_memory=True) for x in train_set]
        self.val_loaders = [td.DataLoader(x, batch_size=cfg.BATCH_SIZE, shuffle=cfg.SHUFFLE,
                                   drop_last=cfg.DROP_LAST, pin_memory=True) for x in val_set]
        self.test_loaders = [td.DataLoader(x, batch_size=cfg.BATCH_SIZE, shuffle=cfg.SHUFFLE, drop_last=cfg.DROP_LAST, pin_memory=True) for x in test_set]
