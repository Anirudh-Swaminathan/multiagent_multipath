...
class MultiAgentNetwork(NNClassifier):
    ...
    def forward(self, img, past_traj, gt_future):
        ...
        print(gt_index.shape, " ", gt_future.shape)
...
class TrainNetwork(object):
    def __init__(self):
        ...
        self.training_dataset = [toyScenesdata(), toyScenesdata("train",agents = 3), toyScenesdata("train",agents = 4)]
        self.val_dataset = [toyScenesdata(set_name="val"), toyScenesdata(set_name="val",agents = 3), toyScenesdata(set_name="val",agents = 4)]
        self.test_dataset = [toyScenesdata(set_name="test"), toyScenesdata(set_name="test",agents = 3), toyScenesdata(set_name="test",agents = 4)]
