...
DATA_PATH = "../data/sets/toy/" #path to data stored
...
class nuScenesdata(Dataset):
    ...
    def __getitem__(self, test_idx):
        ...
        coords = np.load(DATA_PATH+scene+"ls.npy")
        env_map = cv2.imread(DATA_PATH+scene+"scene.png")
        gt = np.load(DATA_PATH+scene+"init.npy")
